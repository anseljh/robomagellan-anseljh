...
This repo has notes, code, and other stuff related to my work toward competing in a Robo-Magellan contest. I plan to do at least the [TableBot challenge](https://github.com/anseljh/tablebot) first, but I've started planning and collecting parts for Robo-Magellan.
...
I haven't thought about the chassis much yet. It needs to be able to hold these heavy motors and the SLA battery, which is 4.5 pounds.

### Motor Driver

The little motor drivers I've used before won't cut it for driving multiple 18V 2A motors, so I needed to get a beefier driver. I settled on the [Cytron 10A 5-30V Dual Channel DC Motor Driver](https://www.robotshop.com/products/cytron-10a-5-30v-dual-channel-dc-motor-driver?variant=42358540009633).
...
A GPS module for $9???? Yep: I got the [HiLetgo GY-NEO6MV2](https://www.amazon.com/gp/product/B01D1D0F5M) for $8.99. It's not the best thing ever, but it works, and did I mention that it was $9? It uses a [Ublox NEO-6M](https://www.u-blox.com/en/product/neo-6-series) GPS module. It's 3V compatible and you just communicate to it over a UART. There's a [CircuitPython GPS library](https://docs.circuitpython.org/projects/gps/en/latest/) that works great.
...
Not sure yet how many distance sensors I need, or what type to use. I have a trusty HC-SR04 ultrasonic sensor which uses 5V, as well as a 3.3V equivalent [RCWL-1601](https://www.adafruit.com/product/4007). [My TableBot](https://github.com/anseljh/tablebot) is using some [little infrared sensors](https://www.amazon.com/dp/B07W97H2WS), but I doubt they'll be good for this application.

### Compute

- [x] Raspberry Pi Pico: Cool little board based on the RP2040 microcontroller. I've been programming these in CircuitPython and it is tons of fun.
- [x] Raspberry Pi Model 3 A+: Process camera images, and send conclusions to the Pico.
